...
project = "cenpy"  # string of your project name, for example, 'giddy'
copyright = '2018, cenpy developers'
author = 'cenpy developers'
...
#
# The full version.
version = cenpy.__version__ #should replace it with your PACKAGE_NAME
release = cenpy.__version__ #should replace it with your PACKAGE_NAME
...
html_short_title = "{} manual".format(project)
...
html_theme_options = {
    ...
    'navbar_title': "cenpy", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'cenpy.tex', u'cenpy Documentation',
...
man_pages = [
    (master_doc, 'cenpy', u'cenpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cenpy', u'cenpy Documentation',
     author, 'cenpy', 'Explore & Process US Census Bureau APIs, Automatically.',
     'Miscellaneous'),
]
